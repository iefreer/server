...
class kuserTableMap extends TableMap {
    ...
    $this->addRelation('KuserGroupRelatedByGroupId', 'KuserGroup', RelationMap::ONE_TO_MANY, array('id' => 'group_id', ), null, null);
    $this->addRelation('KuserGroupRelatedByKuserId', 'KuserGroup', RelationMap::ONE_TO_MANY, array('id' => 'kuser_id', ), null, null);
	} // buildRelations()
